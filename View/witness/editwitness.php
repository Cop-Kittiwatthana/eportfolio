...
include "connect.php";
	...
	if((empty($w_name))||(empty($w_address))||(empty($w_tel))){
		...
		if($fileupload !=""){
			...
			$sql1 = "UPDATE witness1 SET w_id ='$w_id',w_name ='$w_name',w_address ='$w_address',w_tel ='$w_tel',w_pic ='$fileupload_name' WHERE w_id = '$w_id'";
			}
		else{
				$sql1 = "UPDATE witness1 SET w_id ='$w_id',w_name ='$w_name',w_address ='$w_address',w_tel ='$w_tel', WHERE w_id = '$w_id'";
			}
